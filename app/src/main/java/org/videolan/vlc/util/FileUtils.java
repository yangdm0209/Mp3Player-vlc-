...
public class FileUtils {
    ...
    public static String getPathFromURI(Uri contentUri) {
        ...
        try {
            ...
            cursor = AudioApplication.getAppContext().getContentResolver().query(contentUri,  proj, null, null, null);
    ...
    public static boolean deleteFile (String path){
        ...
        if (AndroidUtil.isHoneycombOrLater()){
            ContentResolver cr = AudioApplication.getAppContext().getContentResolver();
