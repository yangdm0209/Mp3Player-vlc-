...
import com.stronger.audioplayer.PlaybackService;
import com.stronger.audioplayer.R;
...
public class MediaUtils {
    ...
    public static void actionScanStart() {
        ...
        LocalBroadcastManager.getInstance(AudioApplication.getAppContext()).sendBroadcast(intent);
    }
